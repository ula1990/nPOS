...
class GiftCardVC: UIViewController {
    ...
    func temporaryGiftCardArray()->[Item]{
        var array: [Item] = []
        let item1 = Item(id: "1", name: "Platinum", imageName: "card", price: 100, vat: 0, desc: "Nice")
        let item2 = Item(id: "2", name: "Gold", imageName: "card", price: 100, vat: 0, desc: "Nice")
        let item3 = Item(id: "3", name: "Best Friend", imageName: "card", price: 100, vat: 0, desc: "Nice")
        let item4 = Item(id: "4", name: "Best Gift", imageName: "card", price: 100, vat: 0, desc: "Nice")
        let item5 = Item(id: "5", name: "Gift", imageName: "card", price: 100, vat: 0, desc: "Nice")
        let item6 = Item(id: "6", name: "Gift", imageName: "card", price: 100, vat: 0, desc: "Nice")
        let item7 = Item(id: "7", name: "Gift", imageName: "card", price: 250, vat: 0, desc: "Nice")
        let item8 = Item(id: "8", name: "Gift", imageName: "card", price: 250, vat: 0, desc: "Nice")
        let item9 = Item(id: "9", name: "All in", imageName: "card", price: 250, vat: 0, desc: "Nice")
        let item10 = Item(id: "10", name: "Present", imageName: "card", price: 250, vat: 0, desc: "Nice")
        let item11 = Item(id: "11", name: "Gift", imageName: "card", price: 250, vat: 0, desc: "Nice")
        let item12 = Item(id: "12", name: "Gift", imageName: "card", price: 250, vat: 0, desc: "Nice")
        let item13 = Item(id: "13", name: "Gift", imageName: "card", price: 50, vat: 0, desc: "Nice")
        let item14 = Item(id: "14", name: "Gift", imageName: "card", price: 20, vat: 0, desc: "Nice")
        let item15 = Item(id: "15", name: "Gift", imageName: "card", price: 250, vat: 0, desc: "Nice")
        let item16 = Item(id: "16", name: "Gift", imageName: "card", price: 40, vat: 0, desc: "Nice")
        let item17 = Item(id: "17", name: "Gift", imageName: "card", price: 40, vat: 0, desc: "Nice")
        let item18 = Item(id: "18", name: "Gift", imageName: "card", price: 40, vat: 0, desc: "Nice")
        let item19 = Item(id: "19", name: "Gift", imageName: "card", price: 40, vat: 0, desc: "Nice")
